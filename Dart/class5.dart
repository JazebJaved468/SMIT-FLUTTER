...
List studentNames = ["Jazeb", "Javed"];   // list

Map studentRecords = {}; // empty map --> (curly brakets)
studentRecords = {"name":"Jazeb",
                  "Rollno": 30,
                   };
...
studentRecords = {"name":["Jazeb", "Zohaib"],
                  "rollno": [30, 43],
                   };
...
Map<String,dynamic> sRecords = {"name":"Jazeb", 'rollno':30};  //here key can only be string but value can be of any datatype bcz of 'dynamic' (var is keyword not a datatype, but dynamic is datatype)

sRecords["gender"] = "male"; // if the key already exist then update the value , if not existed then add that key:value pair
...
sRecords.putIfAbsent('gender', ()=> "female");  // bcz gender key alredy exist so it's value will not be updated
