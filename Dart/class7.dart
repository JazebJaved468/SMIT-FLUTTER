...
void main(){
  ...
  // String username = stdin.readLineSync()!; // use exclamamtion mark after the brackets to remove error of 'string?' datatype
  ...
  //   if(email == 'jazebjaved52@gmail.com' && pass == '12345'){
