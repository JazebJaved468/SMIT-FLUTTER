void main(){
  studentInfo(name: "Jazeb", city:"Karachi");
...
student({String? name}){
  String? a = name ?? "Jazeb"; // agr name mn null agya to wo ?? k baad wali value assign krdega a ko is tarah 'a' mn kabhi null ayega hi ni 
  print(a);
